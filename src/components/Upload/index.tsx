...
const Upload: FC<Props> = ({ onFileSelect, onSelect }) => {
  ...
  return (
    <div>
      ...
      <div className="w-full rounded-md bg-white py-1 px-4 text-left text-sm font-medium text-gray-900 border flex flex-row justify-between items-center h-10">
        ...
        {selectedFile ? (
          <div className="flex flex-row min-w-max gap-2">
            <Select
              ...
              render={{
                anchor: (item) => (
                  <div className="rounded-full bg-slate-100 py-2 px-3.5 text-xs text-gray-500 flex flex-row gap-1 items-center">
